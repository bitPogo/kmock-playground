...
@Mock(
    ExampleContract.SampleRemoteRepository::class,
    ExampleContract.SampleLocalRepository::class,
    ExampleContract.SampleDomainObject::class,
    ExampleContract.DecoderFactory::class
)
class SampleControllerAndroidAutoStubSpec {
    ...
    @Test
    fun It_fulfils_SampleController() {
        SampleController(local, remote) fulfils ExampleContract.SampleController::class
    }

    @Test
    fun Given_fetchAndStore_it_fetches_and_stores_DomainObjects(): AsyncTestReturnValue {
        // Given
    ...
    @Test
    fun Given_find_it_fetches_a_DomainObjects(): AsyncTestReturnValue {
        // Given
    ...
    @Test
    fun Given_find_it_fetches_blocking_a_DomainObjects() {
        // Given
        val idOrg = fixture.fixture<String>()
    ...
    ) : ExampleContract.SampleDomainObject
}
